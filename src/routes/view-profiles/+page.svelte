<script lang="ts">
    ...
    const profile = {
        ...
        bio: "Serial entrepreneur passionate about AI and sustainable technology. Previously founded two successful startups in the renewable energy space. Looking to collaborate on innovative projects that make a real impact.",
        projectProposals: [
            {
                title: "EcoTech Solutions",
                description: "A platform that connects green technology innovators with sustainable investors."
            },
            {
                title: "AI Education Hub",
                description: "Making advanced AI education accessible to underserved communities."
            },
            {
                title: "HealthTech Analytics",
                description: "Using machine learning to predict and prevent health issues before they become serious."
            }
        ]
    };
</script>
